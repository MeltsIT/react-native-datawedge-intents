...
if (Platform.OS === 'android') {
  ...
  var DataWedgeIntents = {
    ...
    ACTION_SCANNERINPUTPLUGIN:
      RNDataWedgeIntents.ACTION_SCANNERINPUTPLUGIN,
    ACTION_ENUMERATESCANNERS:
      RNDataWedgeIntents.ACTION_ENUMERATESCANNERS,
    ACTION_SETDEFAULTPROFILE:
      RNDataWedgeIntents.ACTION_SETDEFAULTPROFILE,
    ACTION_RESETDEFAULTPROFILE:
      RNDataWedgeIntents.ACTION_RESETDEFAULTPROFILE,
...
// This is just so we can run ios without errors
if (Platform.OS === 'ios') {
  var DataWedgeIntents = {
    sendIntent(_action, _parameterValue) {},
    sendBroadcastWithExtras(_extrasObject) {},
    registerBroadcastReceiver(_filter) {},
    registerReceiver(_action, _category) {},
  };
  module.exports = DataWedgeIntents;
}
